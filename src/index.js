...
let allProjects = [
  {
    ...
    projectTasks: [
      ...
      {
        taskTitle: "Do Japanese Homework",
        dateTask: "16/02/2021",
        priorityTask: "Low",
      },
    ],
...

  {
    ...
    projectTasks: [
      ...
      {
        taskTitle: "Get doctor's appointment",
        dateTask: "15/07/2022",
        priorityTask: "Medium",
      },
      {
        taskTitle: "Do History Homework",
        dateTask: "12/04/2022",
        priorityTask: "Low",
      },
    ],
...

  {
    ...
    projectTasks: [
      {
        taskTitle: "Check flight's prices",
        dateTask: "15/10/2022",
        priorityTask: "High",
      },
      { taskTitle: "Sport", dateTask: "09/12/2022", priorityTask: "Medium" },
      {
        taskTitle: "Do Coding Homework",
        dateTask: "04/04/2022",
        priorityTask: "Low",
      },
    ],
